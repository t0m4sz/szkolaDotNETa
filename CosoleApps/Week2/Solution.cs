...
namespace Week2
{
    ...
    {
        public static void ShowSolutionForExercise(int exerciseNumber, string lessonNumber)
        {
            
            if (exerciseNumber == 1 && lessonNumber == "Lesson4")
            {
                Console.WriteLine("Rozwiazanie zadania 1 lekcja 4");
                Console.ReadKey();
            }
            else if (exerciseNumber == 2 && lessonNumber == "Lesson4") 
            {
                Console.WriteLine("Rozwiazanie zadania 2 lekcja 4");
                Console.ReadKey();
            }
            else if (exerciseNumber == 3 && lessonNumber == "Lesson4")
            {
                Console.WriteLine("Rozwiazanie zadania 3 lekcja 4");
                Console.ReadKey();
            }
